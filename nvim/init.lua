...
do
  ...
  -- Disable netrw (built-in file explorer) — use TermFileBrowser instead
  ...
  vim.keymap.set('n', 'XX', '"_dd', { desc = 'Delete line to black hole' })
  ...
  vim.api.nvim_create_autocmd('TextYankPost', {
    ...
    callback = function() vim.hl.hl_op({ op = 'yank' }) end,
  })
end
